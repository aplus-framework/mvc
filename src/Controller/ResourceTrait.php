...
trait ResourceTrait
{
    ...
    /**
     * Responds an HTTP 422 (Unprocessable Entity) status code and data.
     *
     * @param mixed $data
     *
     ...
     * @return Response
     */
    protected function respondUnprocessableEntity(mixed $data = null) : Response
    {
        return $this->respond(Response::CODE_UNPROCESSABLE_ENTITY, $data);
    }
}
